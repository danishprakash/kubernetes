...
func (o *LogsOptions) AddFlags(cmd *cobra.Command) {
	...
	cmd.Flags().Int64VarP(&o.Tail, "tail", "t", o.Tail, "Lines of recent log file to display. Defaults to -1 with no selector, showing all log lines otherwise 10, if a selector is provided.")
